/*
	Credit to @DawnosaurDev for the movement code. 
*/
...
public class MovementPlayer : MonoBehaviour {
	...
	private void Update()
	{
		...
		if (gameOver.getMoving()) {
			_moveInput.x = Input.GetAxisRaw("Horizontal");
			_moveInput.y = Input.GetAxisRaw("Vertical");
			

			if (_moveInput.x != 0 && !IsJumping && !_isJumpFalling && !IsWallJumping && !IsSliding) {
		...
		// the problem is that when the character walljumps, it sets jumping to true, but since its not "isjumping", it sets jumping to false
	...
	public void setControl(Boolean boo) {
		canControl = boo;
	}
